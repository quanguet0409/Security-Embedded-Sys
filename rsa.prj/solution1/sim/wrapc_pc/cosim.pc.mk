...
$(ObjDir)/rsa.cc_pre.cc.tb.o : rsa.cc_pre.cc.tb.cc $(ObjDir)/.dir
	$(Echo) "   Compiling rsa.cc_pre.cc.tb.cc" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/fpga_rsa.cc_pre.cc.tb.o : fpga_rsa.cc_pre.cc.tb.cc $(ObjDir)/.dir
	$(Echo) "   Compiling fpga_rsa.cc_pre.cc.tb.cc" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
