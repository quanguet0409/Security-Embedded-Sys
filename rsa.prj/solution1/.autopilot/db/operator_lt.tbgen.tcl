...
set C_modelArgList {
	{ u int 1 regular {array 32 { 1 3 } 1 1 }  }
	{ v int 64 regular {array 32 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "u", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "u_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "u", "role": "q0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6", "Max" : "163"}
	, {"Name" : "Interval", "Min" : "6", "Max" : "163"}
]}
...
set Spec2ImplPortList { 
	u { ap_memory {  { u_address0 mem_address 1 5 }  { u_ce0 mem_ce 1 1 }  { u_q0 in_data 0 1 } } }
	v { ap_memory {  { v_address0 mem_address 1 5 }  { v_ce0 mem_ce 1 1 }  { v_q0 in_data 0 64 } } }
}
