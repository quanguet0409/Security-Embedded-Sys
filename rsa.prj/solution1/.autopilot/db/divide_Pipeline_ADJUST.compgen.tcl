...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { w_digits_data_V_address0 { O 5 vector } w_digits_data_V_ce0 { O 1 bit } w_digits_data_V_we0 { O 1 bit } w_digits_data_V_d0 { O 64 vector } w_digits_data_V_q0 { I 64 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_k_V_17_out \
    op interface \
    ports { k_V_17_out { O 1 vector } k_V_17_out_ap_vld { O 1 bit } } \
} "
}
