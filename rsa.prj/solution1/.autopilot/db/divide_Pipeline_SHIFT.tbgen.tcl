set moduleName divide_Pipeline_SHIFT
set isTopModule 0
...
set C_modelName {divide_Pipeline_SHIFT}
set C_modelType { int 2 }
set C_modelArgList {
	{ v int 64 regular {array 32 { 2 2 } 1 1 }  }
	{ sh_prom_i_i460_cast_cast int 8 regular  }
	{ sh_prom2_i_i464_cast_cast int 8 regular  }
	{ cmp_i22_i457 int 1 regular  }
	{ zext_ln220_2 int 6 regular  }
	{ retval_0_i_i431274 int 6 regular  }
	{ k_V_out int 64 regular {pointer 1}  }
	{ trunc_ln6_out int 64 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "v", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "sh_prom_i_i460_cast_cast", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "sh_prom2_i_i464_cast_cast", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "cmp_i22_i457", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln220_2", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "retval_0_i_i431274", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "k_V_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "trunc_ln6_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ v_d1 sc_out sc_lv 64 signal 0 } 
	{ v_q1 sc_in sc_lv 64 signal 0 } 
	{ sh_prom_i_i460_cast_cast sc_in sc_lv 8 signal 1 } 
	{ sh_prom2_i_i464_cast_cast sc_in sc_lv 8 signal 2 } 
	{ cmp_i22_i457 sc_in sc_lv 1 signal 3 } 
	{ zext_ln220_2 sc_in sc_lv 6 signal 4 } 
	{ retval_0_i_i431274 sc_in sc_lv 6 signal 5 } 
	{ k_V_out sc_out sc_lv 64 signal 6 } 
	{ k_V_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ trunc_ln6_out sc_out sc_lv 64 signal 7 } 
	{ trunc_ln6_out_ap_vld sc_out sc_logic 1 outvld 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sh_prom_i_i460_cast_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sh_prom_i_i460_cast_cast", "role": "default" }} , 
 	{ "name": "sh_prom2_i_i464_cast_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sh_prom2_i_i464_cast_cast", "role": "default" }} , 
 	{ "name": "cmp_i22_i457", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "cmp_i22_i457", "role": "default" }} , 
 	{ "name": "zext_ln220_2", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln220_2", "role": "default" }} , 
 	{ "name": "retval_0_i_i431274", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "retval_0_i_i431274", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln6_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "trunc_ln6_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	v { ap_memory {  { v_address0 mem_address 1 5 }  { v_ce0 mem_ce 1 1 }  { v_we0 mem_we 1 1 }  { v_d0 mem_din 1 64 }  { v_q0 mem_dout 0 64 }  { v_address1 MemPortADDR2 1 5 }  { v_ce1 MemPortCE2 1 1 }  { v_we1 MemPortWE2 1 1 }  { v_d1 MemPortDIN2 1 64 }  { v_q1 MemPortDOUT2 0 64 } } }
	sh_prom_i_i460_cast_cast { ap_none {  { sh_prom_i_i460_cast_cast in_data 0 8 } } }
	sh_prom2_i_i464_cast_cast { ap_none {  { sh_prom2_i_i464_cast_cast in_data 0 8 } } }
	cmp_i22_i457 { ap_none {  { cmp_i22_i457 in_data 0 1 } } }
	zext_ln220_2 { ap_none {  { zext_ln220_2 in_data 0 6 } } }
	retval_0_i_i431274 { ap_none {  { retval_0_i_i431274 in_data 0 6 } } }
	k_V_out { ap_vld {  { k_V_out out_data 1 64 }  { k_V_out_ap_vld out_vld 1 1 } } }
	trunc_ln6_out { ap_vld {  { trunc_ln6_out out_data 1 64 }  { trunc_ln6_out_ap_vld out_vld 1 1 } } }
}
